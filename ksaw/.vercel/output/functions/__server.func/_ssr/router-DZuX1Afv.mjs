...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DZuX1Afv.js
...
var styles_default = "/assets/styles-ChKvEsAt.css";
...
var Route$4 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "Skill Development – Visvesvaraya Technological University" },
			{
				name: "description",
				content: "Online Registration Portal for Skill Development – Visvesvaraya Technological University"
			},
			{
				name: "author",
			...
			{
				property: "og:title",
				content: "Skill Development – Visvesvaraya Technological University"
			},
			{
...
var $$splitComponentImporter$3 = () => import("./routes-Cz5rRFbC.mjs");
...
var $$splitComponentImporter = () => import("./admin-BGiKcazq.mjs");
